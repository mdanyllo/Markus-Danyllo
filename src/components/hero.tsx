...
export default function Hero() {
  ...
  return (
    <div className="flex flex-col items-center md:mt-40 mt-30 px-4 sm:px-8 md:w-full md:px-16 lg:px-24">
      <div className="flex flex-col items-center w-full gap-10 md:flex-row md:gap-30 md:justify-center">
        <div className="flex flex-col items-center w-full md:items-start md:w-1/3">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-2">Markus Danyllo</h1>
